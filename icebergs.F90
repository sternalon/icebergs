...
subroutine accel(bergs, berg, i, j, xi, yj, lat, uvel, vvel, uvel0, vvel0, dt, ax, ay, debug_flag) !Saving  acceleration for Verlet, Adding Verlet flag - Alon
...
print *,  i, j, xi, yj, lat1, uvel1, vvel1, uvel1, vvel1, dt_2, axn1, ayn1, Runge_not_Verlet
  call accel(bergs, berg, i, j, xi, yj, lat1, uvel1, vvel1, uvel1, vvel1, dt_2, ax1, ay1) !Note change to dt. Markpoint_1
  !call accel(bergs, berg, i, j, xi, yj, lat1, uvel1, vvel1, uvel1, vvel1, dt_2, ax1, ay1, axn1, ayn1, bxn, byn, Runge_not_Verlet) !Note change to dt. Markpoint_1
print *, ax1, ay1
stop
